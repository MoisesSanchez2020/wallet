...
const setAnimationForExtraCards = () => {
  animateExtraCards
    ...
    .to(
      ".card-stack",
      {
        backgroundColor: extraCardsBackgroundColor,
      },
      0
    )
    .to(
...
const setAnimationForCard1 = () => {
  ...
  if (slide2MarginTop === cardPositions.$end.$marginTop) {
    animateCard1.set(".slide-2", { zIndex: 1 }).to(".slide-2", duration / 2, {
      ease: "back.inOut(1.7)",
      marginTop: -30,
      width: 240,
    });
  ...
  if (slide3MarginTop === cardPositions.$end.$marginTop) {
    animateCard1.set(".slide-3", { zIndex: 1 }).to(".slide-3", duration / 2, {
      ease: "back.inOut(1.7)",
      marginTop: -30,
      width: 240,
    });
...
const setAnimationForCard2 = () => {
  ...
  if (slide1MarginTop === cardPositions.$end.$marginTop) {
    animateCard2.set(".slide-1", { zIndex: 1 }).to(".slide-1", duration / 2, {
      ease: "back.inOut(1.7)",
      marginTop: -30,
      width: 240,
    });
  ...
  if (slide3MarginTop === cardPositions.$end.$marginTop) {
    animateCard2.set(".slide-3", { zIndex: 1 }).to(".slide-3", duration / 2, {
      ease: "back.inOut(1.7)",
      marginTop: -30,
      width: 240,
    });
...
const setAnimationForCard3 = () => {
  ...
  if (slide1MarginTop === cardPositions.$end.$marginTop) {
    animateCard3.set(".slide-1", { zIndex: 1 }).to(".slide-1", duration / 2, {
      ease: "back.inOut(1.7)",
      marginTop: -30,
      width: 240,
    });
  ...
  if (slide2MarginTop === cardPositions.$end.$marginTop) {
    animateCard3.set(".slide-2", { zIndex: 1 }).to(".slide-2", duration / 2, {
      ease: "back.inOut(1.7)",
      marginTop: -30,
      width: 240,
    });
...
const setCurrentCardAnimation = () => {
  ...
  if (slide1MarginTop === cardPositions.$behind.$marginTop) {
    animateCurrentCard.set(".slide-1", { zIndex: 2 }, 0).to(
      ".slide-1",
      {
        ease: "back",
        marginTop: 0,
  ...
  if (slide2MarginTop === cardPositions.$behind.$marginTop) {
    animateCurrentCard.set(".slide-2", { zIndex: 2 }, 0).to(
      ".slide-2",
      {
        ease: "back",
        marginTop: 0,
  ...
  if (slide3MarginTop === cardPositions.$behind.$marginTop) {
    animateCurrentCard.set(".slide-3", { zIndex: 2 }, 0).to(
      ".slide-3",
      {
        ease: "back",
        marginTop: 0,
  ...
  if (slide1MarginTop === cardPositions.$top.$marginTop) {
    animateCurrentCard.set(".slide-1", { zIndex: 1 }, 0).to(
      ".slide-1",
      {
        ease: "back",
        marginTop: -30,
  ...
  if (slide2MarginTop === cardPositions.$top.$marginTop) {
    animateCurrentCard.set(".slide-2", { zIndex: 1 }, 0).to(
      ".slide-2",
      {
        ease: "back",
        marginTop: -30,
  ...
  if (slide3MarginTop === cardPositions.$top.$marginTop) {
    animateCurrentCard.set(".slide-3", { zIndex: 1 }, 0).to(
      ".slide-3",
      {
        ease: "back",
        marginTop: -30,
...
// Hide yellow cover after 10 seconds
setTimeout(function () {
...
document.addEventListener("DOMContentLoaded", function () {
  setTimeout(function () {
    ...
    coverDiv.style.transition = "opacity 1s ease-in-out";

    // After the transition, set the cover div to display none
    setTimeout(function () {
      coverDiv.style.display = "none";
    }, 1000); // matches the 1s transition time
  }, 3000); // display cover for 3 seconds
});
